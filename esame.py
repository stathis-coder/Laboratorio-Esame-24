    ...
    for i, line in enumerate(hour_start_list):
        ...
        if i > 0 :
            ...
            if hour_start_list[i][0]==hour_start_list[i-1][0]:
                #appendo la temperatura che corrisponde all'epoch in posizione i alla lista sam_hour_list
                same_hour_list.append(hour_start_list[i][1])
            ...
            if not hour_start_list[i][0]==hour_start_list[i-1][0] and not hour_start_list[i][0]==-1:
                ...
                for j, line in enumerate(same_hour_list):
                    ...
                    if j==1:
                        ...
                        if not trend==prevision_trend and not trend==None:
                            trend_change_count +=1
                            trend=prevision_trend
                        #setto il trend attuale su crescente
                        actual_trend=True
                    ...
                    if j>1:
                        ...
                        if not prevision_trend==actual_trend:
                            ...
                            trend_change_count += 1
                        #imposto il trend(che diventera il trend dell'ora precedente) sulla previsione del trend attuale
                        trend=prevision_trend
